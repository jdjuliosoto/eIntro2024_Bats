# Differential abundance taxa, metabolic pathways and virulence factors across two groups of samples described by PCA-GMM, Bray-Curtis PoCA, PCA of the VST abundance data and Virulence Factors.
